...
class WebDriver(object):
    ...
    @classmethod
    def browse(cls, driver='chrome', timeout=3):
    ...
    def el_send_keys(self, css, text):
        """
        Operation input box.
    ...
    def get_new_window(self,url):
        """
        open new window use given url
        :return:

        Usage:
        get_new_window('https://www.baidu.com')
        """
        urls='window.open("%s")'% url
        self.execute_script(urls)
    ...
    def get_screenshot_allure(self):
